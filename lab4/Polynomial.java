...
// Below is the syntax highlighted version of Polynomial.java from §9.2 Symbolic Methods. 
...
public class Polynomial {
    ...
    public static void main(String[] args) { 
        ...
        System.out.println("p''''(x)      = " + p.differentiate().differentiate().differentiate().differentiate());
    }
